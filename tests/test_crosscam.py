...
def test_empty_report_says_why_rather_than_looking_broken():
    ...
    page = render_html(
        {"generated_at": "2026-09-07T09:00:00Z", "cameras": ["VID-a"], "seeds": 3, "matches": []}
    )
            ...
            "matches": [
                {
                    ...
                    "score": 0.63,
                    "competing_count": 12,
                    "competing_count_capped": True,
                    "plate_anchored": False,
                    "min_trust": 0.5,
                    "rarity_count": 900,
                    "cameras": ["VID-a", "VID-b"],
                    "route_id": "r",
                    ...
                    "sightings": [
                        {
                            ...
                            "seen_at": None,
                            "class": "car",
                            "plate_text": "<script>alert(1)</script>",
                            "crop_ref": None,
                        }
                    ],
                }
